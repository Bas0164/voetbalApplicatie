...
public class SpelersToevoegen {
    ...
    public SpelersToevoegen() {
        ...
        btnOpslaan.setOnAction(e -> {
            ...
            double Irugnummer = Double.parseDouble(rugnummer.getText()); //rugnummer ophalen
            String Snationaliteit = nationaliteit.getValue(); // Geselecteerde nationaliteit ophalen
            double IaantalGoals = Double.parseDouble(aantalGoals.getText()); //aantal goals ophalen
            double IaantalAssists = Double.parseDouble(aantalAssists.getText()); //aantal assists ophalen
